...
if __name__ == '__main__':
    ...
    df_ADe2_sum = get_matrix_as_df(output_folder, 'sum_ea_matrix_ADe2.tsv', sep='\t')
    df_HCe4_sum = get_matrix_as_df(output_folder, 'sum_ea_matrix_HCe4.tsv', sep='\t')
    df_ADe2_freq = get_matrix_as_df(output_folder, 'frequency_matrix_ADe2.tsv', sep='\t')
    df_HCe4_freq = get_matrix_as_df(output_folder, 'frequency_matrix_HCe4.tsv', sep='\t')
